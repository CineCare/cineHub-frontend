        ...
        <Box component="section">
          ...
          <div>
            ...
            <Typography variant="body1" gutterBottom>
              ...
              sur l’accessibilité dans les salles de cinéma du Québec, mettant
              en lumière et promouvant les établissements adoptant des pratiques
              inclusives. Cette initiative découle de recherches approfondies,
              de nombreuses rencontres enrichissantes et expériences, combinées
              au travail collaboratif de notre équipe.
            </Typography>
            <Typography variant="body1" gutterBottom>
              ...
              à la découverte et à l’inclusion.
            </Typography>
            <Typography variant="body1" gutterBottom>
        ...
        <Box component="section">
          ...
          <div>
            <Typography variant="body1" gutterBottom>
              ...
              à notre fonctionnalité de personnalisation avancée.
            </Typography>
            <Typography variant="body1" gutterBottom>
              Nous vous offrons la possibilité de régler de nombreux paramètres
              pour les adapter selon vos préférences et vos besoins.
            </Typography>
            <Typography variant="body1" gutterBottom>
              Notre gamme complète d’options de personnalisation comprend
              notamment :
              <ListItem>
                <ListItemIcon>
                  <LiveHelpIcon />
